...
import { AlertText, PrimaryText, SecondaryText, secondaryTextColor, ThemedView } from './Themed'
...
export default function Picker({
  ...
  return (
    <ThemedView
      style={tw.style(
        'relative py-0 flex-col justify-center web:flex-row web:justify-between web:items-center',
        style,
        {
          cursor: 'pointer'
        }
    ...
    >
      ...
      <RNPickerSelect
        ...
        Icon={() =>
          Platform.OS !== 'web' && (
            <SecondaryText style={tw` py-2.5 -my-0.5`}>
