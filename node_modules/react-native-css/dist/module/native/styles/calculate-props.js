...
import { applyValue, getDeepPath } from "../objects.js";
import { VAR_SYMBOL } from "../reactivity.js";
import { transformKeys } from "./defaults.js";
import { resolveValue } from "./resolve.js";
export function calculateProps(get, rules, guards = [], inheritedVariables = {
  [VAR_SYMBOL]: true
}, inlineVariables = {
  [VAR_SYMBOL]: "inline"
}) {
  ...
  for (const rule of rules) {
    ...
    if (rule.d) {
      let topLevelTarget = rule.s?.[S.Important] ? important ??= {} : normal ??= {};
...
export function applyDeclarations(get, declarations, inlineVariables, inheritedVariables, delayedStyles = [], transformStyles = [], guards = [], target = {}, topLevelTarget = target) {
