...
exports.preprocessTemplateRange = preprocessTemplateRange;
...
function parse(file, options) {
    ...
    try {
        ...
        throw new Error(' [error] [prettier-plugin-sort-imports]: Please install content-tag@^4.0.0 to use this plugin with Ember template tags.');
    }
    const preprocessor = new Preprocessor();
    return preprocessor.parse(file, options);
}
function replaceContents(file, options) {
